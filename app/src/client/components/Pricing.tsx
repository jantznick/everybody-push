...
export const tiers = [
	{
		name: 'Single User',
		id: TierIds.SINGLEUSER,
		priceMonthly: 'Free',
		description: 'Single User Plan',
		features: ['No organizations or teams features', 'All higher level features enabled'],
	},
	{
		name: 'Small Business',
		id: TierIds.SMALLBUSINESS,
		priceMonthly: '$2.99',
		description: 'Perfect for small businesses',
		features: ['No teams features', 'Access control limited to user level'],
		bestDeal: true,
	},
	{
		name: 'Large Business',
		id: TierIds.LARGEBUSINESS,
		priceMonthly: '$9.99',
		description: 'Ideal for 10+ employees and multiple teams',
		features: ['Separate the business into teams ', 'Custome team permissions'],
	},
];
			...
			<div className='mx-auto max-w-7xl px-6 lg:px-8'>
				<div id='pricing' className='mx-auto max-w-4xl text-center'>
					<h2 className='mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl dark:text-white'>
						Pick your <span className='text-blue-700'>pricing</span>
					</h2>
				</div>
				<p className='mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600 dark:text-white'>
					Stripe subscriptions and secure webhooks are built-in. Just add your Stripe Product IDs! Try it out
					below with test credit card number{' '}
					...
					{tiers.map((tier) => (
						...
						>
							{tier.bestDeal && (
								...
								>
									<div
										className='absolute w-full h-full bg-gradient-to-br from-blue-100 to-purple-300 opacity-30 dark:opacity-50'
										style={{
							...
							{!!user && user.hasPaid ? (
								<a
									...
									className={`
                      ${tier.id === 'large-business' ? 'opacity-50 cursor-not-allowed' : 'opacity-100 cursor-pointer'}
                      ${
							tier.bestDeal
								? 'bg-blue-700 text-white hover:text-white shadow-sm hover:bg-blue-500'
								: 'text-gray-600  ring-1 ring-inset ring-purple-200 hover:ring-purple-400'
						}
                      'mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-500'
                    `}
								>
									{tier.id === 'large-business' ? 'Contact us' : 'Manage Subscription'}
								</a>
							) : (
								<button
